...
if TYPE_CHECKING:
    from src.ragforge.models.message import Message


class Conversation(Base, UUIDMixin, TimestampMixin):
    """Database entity model representing independent multi-turn chats."""
    ...
    # Automatically load and sequence child message logs by timeline sequence parameters
