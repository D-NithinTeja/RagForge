...
if TYPE_CHECKING:
    from src.ragforge.models.chunk import Chunk
...
class Document(Base, UUIDMixin, TimestampMixin):
    """Database model for parsing uploaded text assets and tracking metadata configurations."""
    ...
    def mark_processed(
        ...
        """Register extraction metrics and complete processing verification."""
    ...
    def mark_failed(self, error: str) -> None:
        """Capture errors and adjust status limits."""
